...
<body>
    ...
    <div class="all-filters-container">
        <button class="filter-button active" onclick="window.location.href='notificacoes.php'">Todas</button>
        <button class="filter-button" onclick="window.location.href='transporte.php'">Transporte</button>
        <button class="filter-button" onclick="window.location.href='vanuber.php'">VanUber</button>
        <button class="filter-button" onclick="window.location.href='seguranca.php'">Segurança</button>
        <button class="filter-button" onclick="window.location.href='pagamentos.php'">Pagamentos</button>
        <button class="filter-button" onclick="window.location.href='comunicacoes.php'">Comunicações</button>
    </div>
    ...
    <script>
        // Função para mudar o filtro de notificações
        function changeFilter(button, page) {
        ...
        // Configurar botões para usar a função changeFilter
        document.querySelectorAll('.filter-button').forEach(button => {
            button.addEventListener('click', function() {
                const page = this.getAttribute('onclick').split("'")[1];
                changeFilter(this, page);
            });
        });
    </script>
</body>
