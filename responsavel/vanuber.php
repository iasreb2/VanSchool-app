...
<body>
    ...
    <!-- CONTEÚDO PRINCIPAL -->
    <div class="container">
        <h1 class="page-title">VanUber</h1>
        ...
        <div class="drivers-header">
            <div class="drivers-title">Motoristas Disponíveis</div>
            <button class="see-all-button">Ver todos</button>
        </div>
    ...
    <nav class="footer-nav">
        ...
        <a href="vanuber.php" class="nav-item active">
    ...
    <script>
        ...
        // Adicionar evento de clique para o botão "Ver todos"
        document.querySelector('.see-all-button').addEventListener('click', function() {
            alert('Redirecionando para a lista completa de motoristas...');
            // Aqui você pode redirecionar para a página com todos os motoristas
        });
    </script>
</body>
</html>